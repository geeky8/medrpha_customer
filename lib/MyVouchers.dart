                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        // hintText: S.of(context).voucherHint,
                        hintStyle: TextStyle(
                            fontFamily: ConstantData.fontFamily,
                            color: ConstantData.mainTextColor,
                            fontWeight: FontWeight.w400,
                           ...
                           children: [
                             Padding(
                               ...
                               child: Image.asset(ConstantData.assetsPath +
                                   voucherList[index].image, height: imgSize,
                                 width: imgSize,),),
                             ...
                             Expanded(
                               child: Column(
                                 ...
                                 children: [
                                   ...
                                   ConstantWidget.getCustomTextWithoutAlign( voucherList[index].name, ConstantData.mainTextColor, FontWeight.w700, ConstantData.font18Px),
                                   Padding(
                                     padding:
                                     EdgeInsets.only(bottom: defMargin,top: (defMargin/3)),
                                     child:       ConstantWidget.getCustomTextWithoutAlign( voucherList[index].desc, ConstantData.mainTextColor,
                                     ...
                                     children: [
                                       InkWell(
                                         child:  Container(
                                           ...
                                           padding: EdgeInsets.symmetric(horizontal: (defMargin/1.5)),
                                           // width: 120,
                                           decoration: BoxDecoration(
                                           ...
                                           child: Center(
                                             ...
                                             child:  ConstantWidget.getCustomTextWithoutAlign(
                                                 voucherList[index].code, Colors.white,
                                                 FontWeight.w500, ConstantData.font15Px),
                             ...
                             Align(
                               ...
                               child: Column(
                                 ...
                                 children: [
                                   ...
                                   ConstantWidget.getCustomTextWithoutAlign( S
                                       .of(context)
                                       .exp, ConstantData.mainTextColor,
                                       FontWeight.w500, ConstantData.font15Px),
                                   Padding(
                                     padding: EdgeInsets.only(top: defMargin),
                                     child:  ConstantWidget.getCustomTextWithoutAlign( voucherList[index].date, ConstantData.textColor,
                                         FontWeight.w700, ConstantData.font12Px),

                                   ),

                                   ConstantWidget.getCustomTextWithoutAlign(voucherList[index].month,
