...
///  * [ChipWidget], uses tags or descriptive words as a way to filter content.
...
///  * [ChipWidget] a chip that uses tags or descriptive words as a way to
///    filter content.
...
class _RawChipState extends State<RawChip> with TickerProviderStateMixin<RawChip> {
  ...
  Color getBackgroundColor(ChipThemeData theme,bool isSelected) {




    return (isSelected)?ConstantData.accentColor:ConstantData.cellColor;
          ...
          builder: (BuildContext context, Widget child) {
            return Container(
              decoration: ShapeDecoration(
                shape: resolvedShape,
                // color: Colors.red
                color: getBackgroundColor(chipTheme,widget.selected),
              ),
              child: child,
            );
          },
