...
// import 'package:food_delivery_new/ConstantColors.dart';
// import 'model/Message.dart';
// import 'model/User.dart';
        ...
        children: <Widget>[
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(hintText: 'Send a message..',hintStyle:TextStyle (
    ...
    return WillPopScope(
        child: Scaffold(
          ...
          body:  GestureDetector(
            ...
            child: Column(
              children: <Widget>[
                SizedBox(height: ConstantWidget.getScreenPercentSize(context,3.1),),
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: ConstantWidget.getWidthPercentSize(context,1.8),),
                    ...
                    SizedBox(width: ConstantWidget.getWidthPercentSize(context,1),),
                    ...
                    SizedBox(width: ConstantWidget.getWidthPercentSize(context,1.5),),

                    ConstantWidget.getAppBarText((widget.chatModel!=null)?widget.chatModel.name:widget.user.name),
