...
import 'package:flutter_medical_ui/SignInPage.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  new ParallaxContainer(
                    child: ConstantWidget.getCustomText(S.of(context).appName, ConstantData.mainTextColor, 1,
                  ...
                  // ),
                  new ParallaxContainer(
                    child: ConstantWidget.getCustomText("Notifications", ConstantData.mainTextColor, 1,
                  ...
                  new ParallaxContainer(
                    child: InkWell(
                      ...
                      child: ConstantWidget.getCustomText("Skip", ConstantData.mainTextColor, 1,
