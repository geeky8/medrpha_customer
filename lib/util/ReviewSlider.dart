...
class MeasureLine extends StatelessWidget {
  ...
  List<Widget> _buildUnits() {
    ...
    // int lastPosition =( isCash && oValue==1)?1:oValue;
    print("oValue-----$oValue");
    ...
    states.asMap().forEach((index, text) {
      ...
      res.add(LimitedBox(
        ...
        GestureDetector(
          ...
          child: (isCash && index==1)?Container(
            ...
            children: <Widget>[
              ...
              Opacity(
                ...
                child: Text(
                  text,
                  style: optionStyle ?? TextStyle(color: ConstantData.mainTextColor),
                ),
              )
      ...
      child: Stack(
        children: <Widget>[
          Positioned(
            ...
            // width: width - 60,
            width: (oValue == 0)?width - 60:width - 65,
            child: Container(
              width: width,
  ...
  _buildIndicator() {
    return
      Container(
        ...
        child: Icon(Icons.radio_button_checked,size: circleDiameter,color: ConstantData.mainTextColor,),
        // child: Stack(
        //   children: <Widget>[
        //     Head(
