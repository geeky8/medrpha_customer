...
class EditDialog extends StatefulWidget {
  ...
  @override
  _EditDialog createState() {
    return _EditDialog();
  }

  EditDialog(this.context, this.isBool,this.model,this.onChanged);
}
...
class _EditDialog extends State<EditDialog> {
  ...
  void initState() {
    ...
    if(widget.isBool){
      textEditingController.text = widget.model.name;dropdownValue = widget.model.type;
    }
    setState(() {});
  }

  String dropdownValue = 'Youth';

  List<String> spinnerItems = ['Youth', 'GrandParent', 'Children'];
        ...
        children: <Widget>[
          Expanded(
            ...
            child: Column(
              ...
              child:   ConstantWidget.getTextWidget(widget.isBool?S.of(context).edit:S.of(context).addPatient, ConstantData.mainTextColor, TextAlign.start, FontWeight.bold, ConstantData.font22Px),),
