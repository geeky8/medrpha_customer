...
class ConstantWidget {
        ...
        child: Container(
          ...
          child: Center(
            child: ConstantWidget.getTextWidget(
                ...
                TextAlign.start,
                FontWeight.bold,
                ConstantWidget.getPercentSize(bottomHeight, 30)),
          ),
        ),
      ),
      onTap: function,
  ...
  static Widget getDefaultNumberFiledWidget(BuildContext context, String s,
      TextEditingController textEditingController) {
    double height = ConstantWidget.getScreenPercentSize(context, 8.5);

    double radius = ConstantWidget.getPercentSize(height, 20);
    double fontSize = ConstantWidget.getPercentSize(height, 40);
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.only(
              left: ConstantWidget.getWidthPercentSize(context, 2),
              top: ConstantWidget.getWidthPercentSize(context, 17)),
          border: InputBorder.none,
          focusedBorder: InputBorder.none,
          enabledBorder: InputBorder.none,
          errorBorder: InputBorder.none,
