            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  ConstantWidget.getButtonWidget(context, S.of(context).signIn,
                  ...
                  Padding(padding: EdgeInsets.symmetric(vertical: ConstantWidget.getScreenPercentSize(context,.5)),child: Center(
                    child: ConstantWidget.getTextWidget(
                        S.of(context).or,
