...
class _TabWidget extends State<MyHome> with SingleTickerProviderStateMixin {
  // int index = 0;
  ...
  logout() async {
    var url = Uri.parse('https://api.medrpha.com/api/Default/logout');
    String session_id = await PrefData.getSessionID();
  ...
  Future<List<Product>> getProducts() async {
    // return await getProductList(session: '91c65d5706f2ab8b', productName: 'c');
  }
        ...
        child: Scaffold(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ConstantWidget.getDrawerItem(
                        context, 'Logout', Icons.logout, logout),
                    // ConstantWidget.getDrawerItem(context,
                    //     S.of(context).uploadPrescription, Icons.assignment, () {
                    //   Navigator.push(
                    //       context,
                    //       MaterialPageRoute(
          ...
          body: SafeArea(
            child: MotionTabBarView(
              ...
              children: <Widget>[
                //Shopping cart icon and drawer icon
                getHomePage(),
                //This will dispaly all the main content categiy and product listing
                getArticlePage(),
                MyOrderPage(true),
                getChatPage(),
                getProfilePage()
  ...
  getArticlePage() {
    return Container(
      ...
      child: ListView(children: [
        getViewAllCell(S.of(context).topArticle, false, () {}),
        topArticleList(),
        getViewAllCell(S.of(context).recentPost, false, () {}),
        recentPostList(),
        SizedBox(
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          InkWell(
            child: _getCell(S.of(context).cart, Icons.shopping_cart),
            onTap: () {
          ...
          InkWell(
            child:
                _getCell(S.of(context).notification, Icons.notifications_none),
            onTap: () {
  ...
  getHomePage() {
    print("homee----true--building shopping cart icon");
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          //Display the Caption Categories  View All
          // getViewAllCell(S.of(context).categories, true, () {
          //   Navigator.push(
          //       context,
          //       MaterialPageRoute(
          ...
          //Displays teh Products and View All link
          // getViewAllCell(S.of(context).products, true, () {
          //   Navigator.push(
          //       context,
          //       MaterialPageRoute(
          //         builder: (context) => SubCategoriesPage(),
          ...
          //List of all the products original
          trendingList(),
          //list of all the products modified new
          productList(),
          // Container(
          //   child:
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.only(
                        top: ConstantWidget.getPercentSize(height, 6)),
                    decoration: BoxDecoration(
  ...
  productList() {
    double height = SizeConfig.safeBlockHorizontal * 85;
          ...
          builder:
            ...
            if (snapshot.connectionState == ConnectionState.done) {
              if (snapshot.hasData) {
                ...
                if (snapshot.data.length > 0) {
                  return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      Product tempProduct = snapshot.data[index];
                      print(tempProduct.productName);

                      return ProductView(width: width, product: tempProduct);
                    },
                  );
                } else {
                ...
                print('The errror in snapshot: $snapshot.error');
                return const Icon(
                  Icons.error_outline,
                  color: Colors.red,
                  size: 60,
                ...
                print('snapshot has data failed');
                return Text('No Product to display');
              }
            } else {
              return const Center(
  ...
  getViewAllCell(String s, bool isViewAll, Function function) {
    ...
    return Container(
      padding:
          EdgeInsets.symmetric(horizontal: sideMargin, vertical: sideMargin),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          ConstantWidget.getCustomTextWithoutAlign(
